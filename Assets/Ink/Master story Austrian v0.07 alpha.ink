...
Stefan Dobrosavljevic Master Work Generated Tale - Austrian Version v.06 Alpha

*[NEXT]

-Welcome, Bienvenue or should (and I probably should) say Willkomen, my friend to this little adventure we have prepared for you. 
...
-Oh, but let me not scare you my friend. These are little tests, easily avoidable, meant just to see if you are paying attention. Mind to notice. there is nothing fun there - If you die, your adventure will go on, but results will not be as relevant. And you won’t get the super secret bonus at the end.

Also, mind to notice. And listen well! You can’t go back. Once a choice is made, it’s made. It’s saved, locked in a little box and till you finish the game will stay like that.
...
+  A Freiherr
    --Even though, nominally run by Freiherr, no man held single importance, but people gathered together to discuss matters and bring rules.
    ~M2 = 5
    ~realm = "barony"
...
+   Exciting and Dangerous adventures risking one's life for great gains. <>
    ...
    ~M6 = 1
    ~object = "kingdom"
+   Exciting adventures for moderate gains and some benefit to the people. <>
...
{name} lived with {gender_possesive} grandfather who was an old shepherd and taken care of {gender} ever since {pronoun} was a small child. He had told tales of faraway places and mystical lands. Of dragons and their mighty fire breath that swooped and ate whole flocks of sheep. Of great and evil Iron King, leader of the evil Nibelungen dwarves, and of their great wealth in the land of Niflheim, land of darkness and cold.

    {object=="love": 
    
    But what {name} thought of, while grandfather was telling the stories was the beautiful {gender==true:Katharina}{gender==false: Michael} whom {pronoun} loved dearly and with whom {pronoun} had spent many beautiful moments. Every morning, {gender==true:Katharina}{gender==false: Michael} would meet {gender} with an apple in the meadow, where they would spend time lost in dreams. But {name} was hesitant, because {pronoun} believed grandfather wouldn't agree to this marriage. And so lived and loved secretly day by day. But knew things will change soon.
    -else: 
...
Every evening grandfather would light up his big pipe by the firelight of the old stone furnace, and blowing off little clouds as only he knew talk about small spirits who lived in the meadows. Of Feldgeister who inhabited the fields as corn and rye demons. Of old gods, of powerful Wotan and his wife Berchta  who controlled the fates of men, and of forest Kobolds which would help out a lost traveler should he be kind to them. And so forth long into the night, until {name} wouldn't yawn and fall asleep on the big fuzzy rug by the cat, who also fascinated by grandfather's stories would meow, stretch and cozy purring with {name}.
...
"Now" said the grandfather. "I want you to head straight to the market and not dawdle. You will pick up the wool from other gentlemen here and help them as well. None of that funny business, and no taverns, or fancy clothes either. And hurry before dark or Nachzehrer will eat you "
...
==Question5_001a
   ...
   -And as our {name} was walking down the narrow rocky road, {pronoun}  <>         //faux choice to distinguish if attention is paid
...
=Question5_01_intro
    ...
    "Don't worry about me. I will leave the cart with a blacksmith and head onward. Take heed when going back, if you meet the dwarf Kruzimügeli along the way,  don't listen to what he says and more over don't trust him.
...
Suddenly, on a high rock, in the middle of the road, {name} spotted a flickering light and, to {gender_possesive} surprise noticed a mischievous looking dwarf smoking a pipe. And by the small light, {name} recognized him from grandfather’s stories, for it was Kruzimügeli, the deceiver.
...
"So" said the dwarf. "Are you going to circle over and over till the Tatzelwurm finds you and eats you?"
...
Suddenly, on a high rock, in the middle of the road, {name} spotted a flickering light and, to {gender_possesive} surprise noticed a mischievous looking dwarf smoking a pipe. And by the small light, {name} recognized him from his friend's warning, for it was Kruzimügeli, the deceiver.

"Good Sir Kruzimügeli." said {name}. "Know you any place to hide from this god awful weather?"
"Ja." said dwarf happy to have heard his name known. "I would have tricked you and sent you down the cliff, but since you are a good child I shall tell you. Head on up this path now, and trough a little cave. In it you will find a wonderful castle with all kinds of hearts delights. And behind each doors you will find more wonderful things to see. Go now before you freeze."
...
==intermezzo1==
    {M14>2:
    Suddenly, opening one of the doors, {name} was hit back as a form of dark energy swooshed so quickly by {gender} and out of the cave, before {pronoun} could see. immediately after the castle began to shake and crumble, and {name} rushed out of it. When {gender} looked back there was no more of the castle.
    
    
    -else: 
    
    Walking around the castle {name} found the most beautiful ruby {M13>3: that might have been the one {pronoun} was looking for to get back. And besides that it was an object} {object=="love": worthy of {gender_possesive} love, {gender==true:Katharina}{gender==false: Michael} who would no doubt shower our hero with kisses, praise and adoration}{object=="kingdom": worthy of a ruler. My how well it would sit on the crown {name} wanted to forge}. Should {name} take it?
...
*[Next]
    ...
    "What happened, love." asked {gender==true:Katharina}{gender==false:Michael}. But as {name} was about to fall into {gender_possesive} love's arms, a cold wind started to blow, and a Dark Force swooped from the skies grabbing {gender==true:Katharina}{gender==false:Michael} and flying away, leaving {name} in shock and fear.
    }
...
{object=="kingdom":
    ...
    - else:
        warm arms of loving {gender==true:Katharina}{gender==false:Michael}, embracing {gender} in the cold night.
    }
*[Next]
...
+   A Flock of Dragons of all shapes and sizes and colors
    --A horde of dragons, acting as one, listening to each other. Generally solitary creatures, but once joined in a horde, they fly as one destroying all in their wake. Amongst them the strongest and most feared was Black Dragon.
    ~M7 = 1
    ~opposer=" Black Dragon"
+   A Group of big and small Dragons of all colors
    --devouring flocks and people alike. They consult each other, but little ones are listened, but looked with scorn and brushed off aside, if rarely their advice taken. Amongst them the strongest and most feared was Black Dragon.
    ~opposer=" Black Dragon"
    ~M7 = 2
+   Armies of the Iron King and his evil council of dwarves
    --A council of most ruthless metal men, and the Iron King, first amongst them, bringing destruction and cries wherever they march. A great group, a caste of mighty nobles, lead by their ruler Iron King. All others must keep quiet.
    ~opposer="Iron King"
    ~M7 = 3
+   The mighty army of the maleficent dwarf Iron King, an evil autocrat.
    --Only but a few of his metal men can talk to Iron King, for anyone else who dares to speak up, is turned to ashes by his mighty hands.
    ~opposer="Iron King"
    ~M7 = 4
+  The great army of the evil dwarf Iron King. A ruthless absolute tyrant <>
    --whom all who serve need to obey without a word, for he deals with any voice of critique or advice with harsh imprudence. Just like slaves, all those living in his lands must adhere to his will.
    ~opposer="Iron King"
    ~M7 = 5
...
Yet the old man spoke again. "My brothers and sisters, I am an old man, and lived a lot, but I believe there is no mortal creature that can tell us how to stop this coming evil. I suggest we send out the hero who warned us of the danger to the great shrine, where lives the great Goddess who knows all and sees everything.
...
==Question2Q5
+[Next]
-The road winded up the mountain, till it reached a branching fork. On the fork there had been a sign, long broken. {name} stood there, lost, wondering where to go when {pronoun} heard rustling coming from the local trees. Suddenly a voice called out for help. {name} rushed only to find a group of ceremoniously dressed men, tying up a Roggenwölfe, a spirit of the rye, to a big round wheel. The wheel hadn't been fastened so the poor creature rolled around like a sunflower in circles. Having made sure he is nice and tied, they strung him up and left. All but one. // Maybe add Feldgeister as the sacrificed element

The little wolf struggled a bit, but was unable to break the bonds, then seeing {name} from his high place, cried out. "Help me, please {name} as I know of what you seek and can help you."

 {name} stepped out and asked the priest what had happened. 
 "This creature is a trickster and a deceiver. We have strung him up as it is the custom of our land and according to god's laws. Once three days had passed or rolling, we shall take him to the oracle for its further fate."
 
 "Oh, they torture me, and they will surely kill me, just because they consider me evil on my appearance, but I am not so. I feed on corn and acorns."
 
 "You lie spirit, I know it by your horns." said the priest.
 
 The priest turned to the hero. "Remember this creature will say anything to get down."
 
 "Please, help me. And..and...I will help you again. My help is well worth breaking this awful tradition of killing all of us forest spirits."
    
"If we are not to obey our customs, my child, and hunt these demons", spoke the priest, "then we are nothing and will disperse into chaos."
...
+   It is good to  maintain time-honored traditions and norms, but with a little bit of pragmatism.
    --.{pronoun} asked the priest to have a bit mercy, and say of his good deed at the trial. 
    ~M19 = 2
     ~helper="bird"
+   .{name} knew how every society has to maintain some links with its own past but also dealing with the challenges of the present and future.
    --For this he asked them to let Roggenwölfe go.
     ~helper="wolf"
    ~M19 = 3
+   Told the priest to let Roggenwölfe go. Pragmatism comes before customs.
    --To which he grumblingly consented. 
    ~M19 = 4
    ~helper="wolf"
+  Demanded sternly they let Roggenwölfe go. 
...
{ helper=="bird":
        Marching onward down the path, {name} finally saw the fabled temple of the oracle, now half in ruins, rising above the mountain lake. In it once great and lavish celebrations were once held, now but a home to few priests and lost souls. They said that this temple lied at the entrance to the gates of heaven itself. 
        ->helpergod
    - else:
        {name} followed Roggenwölfe up the mountain path, as the creature thanked {gender} and merrily hopped in its diminutive stature, wagging its rye shaped tail. In the end they stood in front of a cave in which Roggenwölfe entered. "Come, {name}, I shall take you to the old witch, the Roggenmuhme, who will tell you of your quest.
        ->helperwolf
    }

==helpergod

When {pronoun} was a little child, {name} heard stories of the proper ceremonies given in this temple. It was the house of Wodan and Berchta, who lead the Evil spirits of the Wild Hunt, called Perchten. They said that improper offering, or wrong move condemned your soul to be devoured. Worst of, sometimes, the error would be so grievous that your soul would be condemned to wander the lost Alpine paths, devoured by Tatzelwurm over and over again. As {pronoun} approached the ruins, {pronoun} noticed an tree leaning over the lake. As {name} approached it, the tree opened and an Berchta, the shining one stepped out, mother of these spirits, and for whom the city of Berchtesgaden was named.

"Come, {name}. Approach the shrine with your offering." said Berchta.

+   [{name} felt very nervous]
    --Berchta valued humility and rules of procedure. Thoughts of making a mistake in {gender_possesive} actions and {gender_possesive} burning in hell obsessed {gender_possesive} mind.
    ~M18 = 5
+   [{name} felt moderately nervous]
    --Berchta valued humility and rules of procedure. Thoughts of making a mistake in {gender_possesive} actions and {gender_possesive} burning in hell obsessed {gender_possesive} mind. But Berchta would have a little understanding if a few missteps were made.
    ~M18 = 4
+   [{name} felt ambiguous]
...
+   [{name} felt moderately confident]
    ----Berchta valued strength and confidence. Even though there was a good risk of doing something improper, our hero didn't care. True, {name} heard of the old stories, but they were just a distant echo, a little nagging voice, before the challenge of the adventure that lay ahead.
    ~M18 = 2
+  [{name} felt very confident]
    --Berchta valued strength and confidence. Even though there was a high risk of doing something improper, our hero didn't care. There was only the challenge of the adventure and nothing else.
    ~M18 = 1
...
{ M18>2:
        As {name} approached the spirit, nervously, it smiled and spoke in the most beautiful voice {pronoun} had ever heard.
        
        "Little mortal, I am an Berchta, wife to the great God Wotan, in this temple. I lead my Perchten, and trough them I knows all of creation of earth and heavens, and matters of heroes. I see you know this well as you approach so softly with respect."
        
    - else:
        As {name} approached the woman showing no fear, she grew to double size and started to glow with bright light, speaking in the most beautiful voice {pronoun} had ever heard. 
        
        "Little mortal, I am an Berchta, wife to the great God Wotan, in this temple. I lead my Perchten, and trough them I knows all of creation of earth and heavens, and matters of heroes. I applaud your daringness in walking so boldly towards me."
    }

{object=="kingdom":
        "I seek to defend our {realm}, oh great goddess. The ruler had declared that one who defends the land from the {opposer} who threatens these lands shall inherit the {realm}, and I seek to claim it and defend its people from the evil forces."
        
    - else:
        Oh, wise Berchta, I beseech you for your help. My love had been kidnapped by the evil {opposer}. I have traveled far and wide to seek knowledge how to save my loved from the evil fate.
    }

        "Very well, I shall tell you. I have seen your fate take you east to the kingdoms plagued by the evil {opposer} you speak of. You will fight lesser minions and in saving the kingdom, king will reward you with a sword that you will need to defeat the evil {opposer}.
        ...
        And with that the Berchta, clapped her hands, bringing upon {name} a storm that picked {gender} up and flew {gender} in to the far far lands of the east.
        
->Chapter31

==helperwolf

The cave was dark, and wet. And as Roggenwölfe dragged {gender} further, {name} was wondering about what {pronoun} got {gender}self. Finally, Roggenwölfe stopped and showed at a dark stone door in the far end of the cave. 

    "Move this stone, {name} and behind it you will find a little forest clearing. On that clearing there will be a hut in rye with spikes around, with skulls on it. Ahead of the hut will be dogs, she uses them to lure the children and blow the light from their eyeballs. If someone is to know what you as of, it is her. But, as much as she is knowledgeable, she is also fond of human flesh. Sometimes even too much, so once she starts thinking of it, she can be fooled. Oh, be careful, {name}. I know I have promised you help, but I fear something awful might happen to you here." And with that warning, the Roggenwölfe hopped away.


-So, {name} moved the stone and went into the clearing and indeed there was a narrow hut, surrounded by a field of rye with wooden spikes and heads on spikes, and little dogs running around. 

As the dogs saw him, they started barking in a chorus together, and a voice of an old woman came out from the cottage.
...
+   [{name} felt ambiguous]
    ...
    ~M18 = 3
+   [{name} felt moderately confident]
    --Witches would be defeated trough independence, strength and confidence. Though, some rules needed to be obeyed. True, {name} heard of the old stories of Roggenmuhme (a witch which that was sometimes helpful, and sometimes devoured those lost in the corn) , but they were just a distant echo, before the challenge of the adventure that lied ahead.
    ~M18 = 2
+  [{name} felt very confident]
...
==helperwolf2
    ...
    { M18>2:
        ...
        "Little {name}, I am Roggenmuhme, a witch. But not just any witch, I am the Queen of all witches and Rye spirits, master of these fields. I see you know this well as you approach so softly with respect. But still, it has been a while since I tried a suckling young mortal. I will boil you and eat you. And then put your head on the spike in front of my hut."
    ...
    - else:
        ...
        "Foolish little {name}, don't you know who I am. I am Roggenmuhme, a witch. But not just any witch, I am the Queen of all witches and Rye spirits, master of these fields. For this brash and disrespectful behavior I will eat you, for it's been a while since I tried a suckling young mortal. I will boil you and eat you. And then put your head on the spike in front of my hut."
    }
...
# add A BIT OF FLAVOUR
    ...
    - else:
        Oh, wise Roggenmuhme, I beseech you for your help. My love had been kidnapped by the evil {opposer}. I have traveled far and wide to seek knowledge how to save my loved from the evil fate.
    }
...
-{name} landed in a kingdom amongst the plains, where the sight of {gender_possesive} mountains looked far far away. In this kingdom lived a king who was terrorized by <> 
    ...
    { opposer == "Iron King":
        three stout dwarves. These dwarves, creatures of the caves and the underworld lay close to Hel, where dead souls went. Their skin bathed in the waters of iron, thickened by constant battle that no sword could harm them and no arrow pierce them. These weren't just any three Nibelungs. No, but Lieutenants of Iron King's Grand Army now set on this kingdom to pillage and loot.
        ~Chapter3_badguys = "Nibelungen dwarves"
        
    - else:
        three dragons with three heads each from the Great flock, who ate the livestock and villagers, terrorizing the countryside. Creatures broke off from the main horde now set on this kingdom to pillage and loot.
        ~Chapter3_badguys = "dragons"
    }
    
    {name} heard tales from the frightened villagers, so {pronoun} decided to head towards the kings castle and offer help so that {pronoun} might obtain the magic sword that the king possessed.
    
    ->Chapter3Q1
    
==Chapter3Q1    
    -But the road was long and {name} grew tired, so {pronoun} sat in the long shadow of a tree, pausing for the hour. While eating his provisions, and elderly man dressed in rags approached him, begging for some food. {name} broke off half a bread and gave it to the old man.
    
    "Thank you, my boy. Thank you for your generosity." Now the old man pulled a strange chess set with the carved figurines. "Nothing like a nice game after lunch.  Say, would you like to play a game with me."
...
==Chapter3Q1B
 ...
 { M11 < 4:
        After finishing the game {name} was about to go, when the old man stopped him and said. "Thank you for your generosity and time, young hero. Now let me return the kindness. Know, when you fight the {Chapter3_badguys}, know <> { Chapter3_badguys=="dragons": you must cut off all of their heads in a single swing, or else they will regrow three fold. } {Chapter3_badguys=="Nibelungen dwarves": you must cut off their beards with a single swing, because in them hides their power.}
...
As {name} rushed down the road, {pronoun} saw a group of a few lesser {Chapter3_badguys} who were roughing up some peasants. Strangely enough they held a little golden cage, and in it there sat a little Wolpertinger, in a form of a rabbit with wings and little antlers, with a gloomy face. As {name} was approaching them, three of the group of {Chapter3_badguys}  were bickering about what to do with the cage.

 { Chapter3_badguys == "Nibelungen dwarves":
        The bigger one of the dwarves, dressed in shiny oily leather with strings of gold said. "Iron King ordered us to bring all peasants back to his Dark Keep in Niflheim." 
        
        "No" said an smaller one with a silver chain dress. "This is not a peasant, it is a very small bird. It should be brought to the three lieutenants."
        
        "No" said the even smaller one with a shiny golden circles on his braid. "This is obviously a rabbit. I'm hungry. Let’s eat it."
        
    - else:
        The bigger green dragon said. "All peasants need to be taken back to the Black Dragon, back to his Dark Keep."
        
        "No", said a smaller dragon, as flames burst from his jaws. "This is not a peasant, it is a very small bird. It should be brought to the three lieutenants."
        
        "No" said the even smaller one with its snake tongue sliding between its teeth nervously."This is obviously a rabbit. I'm hungry. Let’s eat it."
    }
...
==Chapter3Q2C
    ...
    -"Thank you, big human." said the little wolpertinger in a cage, as {name} opened the little door. "I am an spirit of the mountains, trapped here by these evil creatures. Here, take a feather from my wings. If you ever need of my help, just rub it between your fingers." said the creature and flew away.
...
==Chapter3Q4B
    ...
    And by morning, {Chapter3_badguys} lied down in throng beneath their feet. But yet again the three lieutenants were not there.
...
{ M22>2:
        ...
        Slashing trough the monster hordes, {pronoun} reached a small clearing by the lake where the three lieutenants of the {opposer}'s army. 
-else: 
        And with that {name} held {gender_possesive} stood {gender_possesive} ground, until finally the three lieutenants of the {opposer}'s army came before {gender}.
    }
...
==Chapter3Q5
 ...
 "Roar."  Said one of the creatures. "So you are the one who keeps us away from the princess. By Gods, we shall eat you where you stand."
 
    But {name} was not easy to frighten. {pronoun} grabbed the sword and struck at the creatures.
    
    {M11 < 4: 
        Remembering the words of the old man, {name} sliced all of the <> 
            {Chapter3_badguys=="dragons": heads in a single swing} {Chapter3_badguys=="Nibelungen dwarves": beards with a single swing.}
        ->Chapter3Q5feast
    -else:
        {name} hacked and slashed, but however times {pronoun} might have hit the lieutenants, <>
            {Chapter3_badguys=="dragons": their hide was as tough as leather and heads kept on regrowing} {Chapter3_badguys=="Nibelungen dwarves": their bodies took no blows, for their skin was sturdy and iron.}
        ->Chapter3Q5Chase
    }
    
==Chapter3Q5Chase

"Surrender mortal" said three creatures, laughing. "You cannot defeat us." 

And just as desperation started to set in, the old man whom {name} once feed by the road, huffing and puffing, appeared. 

"Damn. I wanted to tell you, but you ran away too quickly." said the old man. " {Chapter3_badguys=="dragons": You must chop off all heads of the dragons in a single swing. Otherwise they will keep on regrowing. "} {Chapter3_badguys=="Nibelungen dwarves": You must cut all of their beards with a single swing. This is where their power lies."}

    Hearing their weakness exposed, the three lieutenants ran, over the fields and into the lake that parted before them and {name} gave chase thinking if only {pronoun} knew this sooner.
...
{M12>3 :
    ...
    "Take this wealth and let us live." said the monsters. "We will give it all to you."
    
    But {name} had no mercy for them for {pronoun} know what misdeeds were done and horrors they will do if let go, so with a single slash vanquished them all.
-else:
    "Impossible, no such mortal man is so devoid of temptation." said the creatures. And {name} saw this for what it is, an illusion meant to trick {gender}. So with a single slash {pronoun} had vanquished them.
...
-else:
    "Milord I thank you for these gifts, but I have no needs for so many trinkets. And remember, there is still great danger over the land while the evil {opposer} lives. Give me the magic sword and I must leave you.
     ...
     { pronoun=="She" && object=="kingdom":
        "But my valiant heroine, I still must give you the half of kingdom as promised. And though you cannot marry my daughter, I hope one day in the future you can rule as friends and co-queens."
...
-
 ...
 ==Chapter4   
 And with the sword, the king gave {name} the best horse in the kingdom, and sent {gender} on {gender_possesive} way to the north in the lands of Niflheim, on the entrance to the Underworld, land covered by cold and mist and darkness that {opposer} brought.
 ...
 -As {name} was riding down the road, {pronoun} heard a familiar voice.
    ...
    {helper=="wolf":
        ...
        It was the little Feldgeister, Roggenwolf, {name} saved from the priests, sitting on a rock, looking at the road. 
        
        "I need of your help."
        
        "I am in great rush now, friend Roggenwolf. I need to defeat the evil {opposer} before he has taken over all land. Surely, this task is not that difficult?"
    ...
    It was the dwarf Kruzimügeli. He sat on a low branch of an ash tree, swinging 
...
Really. It was there like 50 times?!? Krumplestilskin?!? Ok, now I kill you for good. You are dead.
...
+Please, I promise to take it seriously and not sabotage the research anymore. And try to be serious and all and swear it, so may Krumplestilskin take my soul if I don't.

-You mean, Kruzimügeli?

+Yes, Kruzim..Kartof..Kurz..Yes that guy
...
*[Next]
    {M13<4 && helper=="wolf":
        ...
        "Here" said the {helper}. "Come out, Habergeiß. And meet the hero."
        
        Suddenly a monster, a great goat with wings, standing up on its back legs jumped in front of them.
        
        "Stay your sword, { pronoun=="He" && object=="kingdom": prince}{ pronoun=="She" && object=="kingdom": princess} {name}. I mean to help you. I am Habergeiß, one of the rye spirits. Once called for bountiful harvest, now just an abandoned spirit."
        
        "What brings you to this barren land?"
    
        "I seek to vanquish the evil {opposer}."
    
        "By Gods, then I might get my Rye fields back."
    
        "See, I knew I could help". The Roggenwolf wagged its tail happily.
       ...
       {M13<4: Why, with love and compassion?}
        ...
        Habergeiß bleated with laughter.
    ...
    "Well, you were lucky my boy for paying attention to these things, names of dwarves." The ash tree opened and an Eschenfrau walked out of it.
    
    "Now my little one, what brings you to this barren land?"
...
-
    ...
    There  { helper=="wolf": Habergeiß}{ helper=="bird": Eschenfrau} took the bucket with the water from the village and drank.
    
    "Ahhh, thank you. I have longed to drink from this well so long."
    
    "And now you can unsheathe the sword?" asked {name}.
    
    "Oh, sure. That's easy. Here, just turn this picture like this, so that the carvings overlap, and now, turn the handle and read these words."
    ...
    And with a mischievous laugh, { helper=="wolf": Habergeiß jumped high in the air}{ helper=="bird": Eschenfrau slipped in the willow tree}.
    
    ->Chapter4Q2E

==Chapter4Q2E
+[Next]
-Marching across the ice misty land, {name} reached the great Gate of the {Chapter3_badguys}. It served as the outer ring of the Dark Keep, home of the fierce {opposer}. It was a monumental building, with carvings of the past, by generations and generations of {Chapter3_badguys == "dragons": dragons and wyrms}{Chapter3_badguys == "Nibelungen dwarves": metal and clay dwarves} had carved. It was an epochal structure significant to the whole monster kind.
   ...
   Now, hero, this is the Great Gate, behind it lies the Dark Keep and inside sits a golden throne and on this throne sits the {opposer}. Now we can try to get inside secretly without the {Chapter3_badguys} seeing us. But it will be perilous.
    ...
    +[Suddenly {name} remembered the birds feather in {gender_possesive} pocket.] 
    
    -{pronoun} rubbed it between his fingers, and the little Wolpertinger appeared.

    "How may I help you, friend." asked the bird.
...
*[Sneak me in?]
    ...
    ->Chapter4Q3B
*[Collapse the gate?]
    -The bird nodded and disappeared, appearing only moments later with a flock of its kind. Together they flapped their wings and formed a whirlwind that blew the gate apart.  
...
==Chapter4Q3B
    ...
    The bird nodded and disappeared, appearing only moments later with a flock of its kind. Together they grabbed the hero and headed on over the gate.
...
{object=="love":
    ...
    "No" thought {name}. "To come so far and to be eaten by this creature. My dear love. What will happen to my dear {gender==true:Katharina}{gender==false:Michael}". And with that thought the sword began to radiate and glow.
}
...
{object=="kingdom":
    ...
    {opposer =="Iron King":
        And with a mighty swing, {name} split the metal giant, out of whom jumped out a wolf. {name} slashed the wolf, out of whom jumped a fox, whom {name} also split. Out of the fox, jumped a rabbit, but {name} quickly caught it and killed it. Out of the rabbit flew a bird, whom {name} quickly shot. Out of the bird then dropped an egg that cracked on the floor, thus destroying evil one's soul. 
        
        With Iron King dead the hero opened the cells freeing the enslaved people, who thanked {gender} as they walked out.
    -else: 
...
{object=="love":
    ...
    And finally, out of the {opposer=="Iron King":'s dungeon}{opposer=="Black Dragon":'s belly}came out {gender==true:Katharina}{gender==false:Michael}, who ran in {name}'s arms, finally reunited with their love.
}
+[Next]
->Chapter4Q4
...
+  Adventure awaits. More challenges, coziness be damned!
    --yes I know it's a fun answer, but answer what you would do in hero's shoes. Do be serious.
    ~M1 = 5
...
{No_of_death==5 && gde_je_bio == "Chapter4": ->kurcspecial} //if killed by Kruzimügeli

{No_of_death==6: ->too_many_deaths}
...
{gde_je_bio == "helperwolf2": ->gde_je_bio}
