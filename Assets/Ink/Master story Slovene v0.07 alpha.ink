...
Stefan Dobrosavljevic Master Work Generated Tale - Slovene Version v.06 Alpha

*[NEXT]

-Welcome, Bienvenue or should (and I probably should) say dobrodošel, my friend, to this little adventure we have prepared for you. 
...
+  A simple Baron
    --Even though, nominally run by Baron, no man held single importance, but people gathered together to discuss matters and bring rules.
    ~M2 = 5
    ~realm = "barony"
...
{name} lived with {gender_possesive} grandfather who was an old shepherd and had taken care of {gender} ever since {pronoun} was a small child. He had told tales of faraway places and mystical lands. Of dragons, or zmajs with 7 heads  and their mighty fire breath that swooped and ate whole flocks of sheep. Of great and evil Vedomec, a sorcerer, leader of the armies of evil hudobni škarts (dwarves), and of their great wealth in the lands behind the Glass Mountain, land of darkness and cold.

    {object=="love": 
    
    But what {name} thought of, while grandfather was telling the stories was the beautiful {gender==true:Katja}{gender==false: Martin} whom {pronoun} loved dearly and with whom {pronoun} had spent many beautiful moments. Every morning, {gender==true:Katja}{gender==false: Martin} would meet {gender} with an apple in the meadow, where they would spend time lost in dreams. But {name} was hesitant, because {pronoun} believed grandfather wouldn't agree to this marriage. And so lived and loved secretly day by day. But knew things will change soon.
    -else: 
...
Every evening grandfather would light up his big pipe by the firelight of the old stone furnace, and blowing off little clouds as only he knew talk about small vilas or fairies  who lived in the meadows, and would sunbathe over the cliffs looking at the Great Sea. Of Lisica Zvitorepka, with her curly tail, who would outsmart and outfox all who would who try to catch her.  Of old gods, now forgotten by time, who inhibited dark caves and abandoned crossroads. Of Povodni Mož, who kidnapped women and drags them deep in his lake, of Brdavs - a gigantic crude, heartless fighter who would slay all those whom he defeated. Of Ajdi, mystical giants who knew of things mortal minds have not yet heard of. Of kurenti, feathered and horned devils who would chase away the evil.  And so forth long into the night, until {name} wouldn't yawn and fall asleep on the big fuzzy rug by the cat, who also fascinated by grandfather's stories would meow, stretch and cozy purring with {name}.
...
"Now" said the grandfather. "I want you to head straight to the market and not dawdle. You will pick up the wool from other gentlemen here and help them as well. None of that funny business, and no taverns, or fancy clothes either. And hurry before dark or Bedanc will eat you "
...
==Question5_001a
   ...
   -And as our {name} was walking down the narrow rocky road, looking up in the air if a great big eagle will scoop on {gender_possesive}, so {pronoun} can grab a new feather for {gender_possesive} hat,  {pronoun} <>         
...
=Question5_01_intro
    ...
    "Don't worry about me. I will leave the cart with a blacksmith and head onward. Take heed when going back, if you meet the dwarf Špicparkeljc along the way,  don't listen to what he says and more over don't trust him.
...
Suddenly, on a high rock, in the middle of the road, {name} spotted a flickering light and, to {gender_possesive} surprise noticed a mischievous looking dwarf smoking a pipe. And by the small light, {name} recognized him from grandfather’s stories, for it was Špicparkeljc, the deceiver.
    
So, ignoring him, {name} rushed past the rock and headed off down the path.

But circling again around the narrow mountain path, {name} ended up in the same place and again {name} saw the škrat  on a rock looking {gender} with a wicked smile.
...
"So" said the dwarf. "Are you going to circle over and over till the divlji mož finds you and eats you?"
...
Suddenly, on a high rock, in the middle of the road, {name} spotted a flickering light and, to {gender_possesive} surprise noticed a mischievous looking dwarf smoking a pipe. And by the small light, {name} recognized him from his friend's warning, for it was Špicparkeljc, the deceiver.

"Good Sir Špicparkeljc." said {name}. "Know you any place to hide from this god awful weather?"
...
*[Next]
    ...
    "What happened, love." asked {gender==true:Katja }{gender==false:Martin}. But as {name} was about to fall into {gender_possesive} love's arms, a cold wind started to blow, and a Dark Force swooped from the skies grabbing {gender==true:Katja}{gender==false:Martin} and flying away, leaving {name} in shock and fear.
    }
...
{object=="kingdom":
    ...
    - else:
        warm arms of loving {gender==true:Katja}{gender==false:Martin}, embracing {gender} in the cold night.
    }
*[Next]
...
+   A Flock of Dragons of all shapes and sizes and colors
    --A horde of dragons, acting as one, listening to each other. Generally solitary creatures, but once joined in a horde, they fly as one destroying all in their wake. Amongst them the strongest and most feared was Zmaj with seven heads.
    ~M7 = 1
    ~opposer=" Zmaj with seven heads"
+   A Group of big and small Dragons of all colors
    --devouring flocks and people alike. They consult each other, but little ones are listened, but looked with scorn and brushed off aside, if rarely their advice taken. Amongst them the strongest and most feared was Zmaj with seven heads.
    ~opposer=" Zmaj with seven heads"
    ~M7 = 2
+   Armies of the Vedomec and his evil council of dwarves
    --A council of most ruthless hudobni škrats, and the Vedomec, first amongst them, bringing destruction and cries wherever they march. All others must keep quiet.
    ~opposer="Vedomec"
    ~M7 = 3
+   The mighty army of the maleficent Vedomec, an evil autocrat.
    --Only but a few of his metal men can talk to Vedomec, for anyone else who dares to speak up, is turned to ashes by his mighty hands.
    ~opposer="Vedomec"
    ~M7 = 4
+  The great army of the evil Vedomec. A ruthless absolute tyrant <>
...
Yet the old man spoke again. "My brothers and sisters, I am an old man, and lived a lot, but I believe there is no mortal creature that can tell us how to stop this coming evil. I suggest we send out the hero who warned us of the danger to the great lands behind the hills, where live the great Ajdi who know all and see everything.
...
“You think you see a maiden, but in truth this is Lisica Zvitorepka, a trickster and a deceiver. She had turned into a maiden to get away after pillaging chicken coops in our village, but we managed to catch her and tie her up here.”
"Oh, they torture me, and they will surely kill me, just because I had to eat. Surely, I don’t deserve a fate such as this.”
 ...
 The priest turned to the hero. "She tells you only half truths. Indeed, in this river lives a creature called Povodni Mož."
...
+   .{name} knew how every society has to maintain some links with its own past but also dealing with the challenges of the present and future.
    --For this he asked them to let Lisica Zvitorepka go.
     ~helper="fox"
    ~M19 = 3
+   Told the priest to let Lisica Zvitorepka go. Pragmatism comes before customs.
    --To which he grumblingly consented. 
    ~M19 = 4
    ~helper="fox"
+  Demanded sternly they let Lisica Zvitorepka go. 
...
{ helper=="bird":
        Marching onward down the path, {name} finally saw the fabled arches leading to the land of Aidi, now half in ruins, rising above the mountain lake. In it once great and lavish celebrations were once held, now but a home to Moras and Kikimoras and other lost souls (with an occasional volkodlak passing by). They said that this temple once lay at the entrance to the gates of heaven itself. Hero hoped to find at least on living Ajdi to ask for advice.
        ->helpergod
    - else:
        {name} followed Lisica Zvitorepka up the mountain path, now turned back to a fox, as the creature thanked {gender} and merrily hopped in its diminutive stature, wagging its curly  tail. In the end they stood in front of a cave in which Lisica Zvitorepka entered. "Come, {name}, I shall take you to the old witch, the Jaga Baba, who will tell you of your quest.
        ->helperwolf
    }

==helpergod

When {pronoun} was a little child, {name} heard stories of the proper ceremonies given in this temple. It was the house of Ajdi, who were here before any God our {name} knew of. They said that they rarely mixed with mortal men, and improper behavior condemned your soul to be devoured.  They were as tall as trees, with powerful hands, and machines that made miracles happen. And then one day, over a thousand years ago, they just disappeared, yet many names remained with their signs, like Spodnja Hajdina, Zgornja Hajdina, Ajdovščina or Ajdovski gradec. As {pronoun} approached the ruins, {pronoun} noticed a tree leaning over the lake. As {name} approached it, he saw a giant man, bent under it, his feet dipped in water. He turned his giant head, saw our hero and spoke in a thundering voice.

"Come, {name}. Approach the shrine with your offering." 

+   [{name} felt very nervous]
    --Ajdi valued humility and rules of procedure. Thoughts of making a mistake in {gender_possesive} actions and upsetting the giant obsessed {gender_possesive} mind.
    ~M18 = 5
+   [{name} felt moderately nervous]
    -- Ajdi valued humility and rules of procedure. Thoughts of making a mistake in {gender_possesive} actions and {gender_possesive} burning in hell obsessed {gender_possesive} mind. But they would have a little understanding if a few missteps were made.
    ~M18 = 4
+   [{name} felt ambiguous]
...
+   [{name} felt moderately confident]
    ---- Ajdi valued strength and confidence. Even though there was a good risk of doing something improper, our hero didn't care. True, {name} heard of the old stories, but they were just a distant echo, a little nagging voice, before the challenge of the adventure that lay ahead.
    ~M18 = 2
+  [{name} felt very confident]
    -- Ajdi valued strength and confidence. Even though there was a high risk of doing something improper, our hero didn't care. There was only the challenge of the adventure and nothing else.
    ~M18 = 1
...
{ M18>2:
        As {name} approached the giant, nervously, it smiled and spoke in a reassuring voice.
        
        "Little mortal, I am Svitogor, last of my kind. Once I pass away, there will be no others of my kind here. We once had great buildings with circular columns, rising to heavens. Soared the seas and mountains. But alas, our time had come, so you man can live, but with you we left some of our knowledge. I see you know this well as you approach so softly with respect."
    ...
    - else:
        ...
        "Little mortal, I am Svitogor, last of my kind. Once I pass away, there will be no others of my kind here. We once had great buildings with circular columns, rising to heavens. Soared the seas and mountains. But alas, our time had come, so you man can live, but with you we left some of our knowledge. Only daring had we achieved this, and I applaud yours in walking so boldly towards me."
    }

{object=="kingdom":
        "I seek to defend our {realm}, oh great giant. The ruler had declared that one who defends the land from the {opposer} who threatens these lands shall inherit the {realm}, and I seek to claim it and defend its people from the evil forces."
        
    - else:
        Oh, wise giant, I beseech you for your help. My love had been kidnapped by the evil {opposer}. I have traveled far and wide to seek knowledge how to save my loved from the evil fate.
    }
        ...
        And with that Svitogor, clapped his hands, bringing upon {name} a storm that picked {gender} up and flew {gender} in to the far far lands of the east.
        
->Chapter31

==helperwolf

The cave was dark, and wet. And as Lisica Zvitorepka dragged {gender} further, {name} was wondering about what {pronoun} got {gender}self. Finally, Lisica Zvitorepka stopped and showed at a dark stone door in the far end of the cave. 
...
+   [{name} felt ambiguous]
    ...
    ~M18 = 3
+   [{name} felt moderately confident]
    --Witches would be defeated trough independence, strength and confidence. Though, some rules needed to be obeyed. True, {name} heard of the old stories of Jaga Baba (a witch which that was sometimes helpful, and sometimes devoured those lost in the corn) , but they were just a distant echo, before the challenge of the adventure that lied ahead.
    ~M18 = 2
+  [{name} felt very confident]
...
==helperwolf2
    ...
    { M18>2:
        ...
        "Little {name}, I am Jaga Baba, a witch. But not just any witch, I am the Queen of all witches and monsters. I see you know this well as you approach so softly with respect. But still, it has been a while since I tried a suckling young mortal. I will boil you and eat you. And then put your head on the spike in front of my hut."
    ...
    - else:
        ...
        "Foolish little {name}, don't you know who I am. I am Jaga Baba, a witch. But not just any witch, I am the Queen of all witches and monsters. For this brash and disrespectful behavior I will eat you, for it's been a while since I tried a suckling young mortal. I will boil you and eat you. And then put your head on the spike in front of my hut."
    }
...
# add A BIT OF FLAVOUR
    ...
    - else:
        Oh, wise Jaga Baba, I beseech you for your help. My love had been kidnapped by the evil {opposer}. I have traveled far and wide to seek knowledge how to save my loved from the evil fate.
    }
...
-{name} landed in a kingdom amongst the plains, where the sight of {gender_possesive} mountains looked far far away. In this kingdom lived a king who was terrorized by <> 
    ...
    { opposer == "Vedomec":
       A large dark man by the name of Brdaus. They say he rode out from Vražiji Graben, behind the Glass Mountain where Hudič preyed on souls. His skin bathed in the waters of iron, thickened by constant battle that no sword could harm nor no arrow pierce him. He was a Lieutenant of Vedomec's Grand Army now set on this kingdom to pillage and loot. With him, an army of hudobni škrats.
        ~Chapter3_badguys = "hudobni škrats"
        
    - else:
        A Three-Headed dragon with three heads of different color from the Great flock, who ate the livestock and villagers, terrorizing the countryside. Creatures broke off from the main horde now set on this kingdom to pillage and loot under the great wing of the Zmaj with seven heads.
...
==Chapter3Q1    
    ...
    "Thank you, my boy. Thank you for your generosity. Phew, danger, danger, danger. Everywhere you look. I am Kosobrin."
 Now the old man pulled a strange chess set with the carved figurines. "Nothing like a nice game after lunch.  Say, would you like to play a game with me."
    ...
    "True, but one needs to find always a bit of a time for fun, no?" Kosobrin winked.
...
==Chapter3Q1B
 ...
 { M11 < 4:
        After finishing the game {name} was about to go, when Kosobrin stopped him and said. "Thank you for your generosity and time, young hero. Now let me return the kindness. Know, when you fight the {Chapter3_badguys}, know <> { Chapter3_badguys=="dragons": you must cut off all of its heads in a single swing, or else they will regrow three fold. } {Chapter3_badguys=="Hudobni škrats": you must cut off his beard with a single swing, because in them hides his power.}
...
As {name} rushed down the road, {pronoun} saw a group of a few lesser {Chapter3_badguys} who were roughing up some peasants. Strangely enough they held a little golden cage, and in it there sat a little zlatna ptička, or a golden bird, with a gloomy face. As {name} was approaching them, three of the group of {Chapter3_badguys}  were bickering about what to do with the cage.

 { Chapter3_badguys == "Hudobni škrats":
        The bigger one of the dwarves, dressed in shiny oily leather with strings of gold said. "Vedomec ordered us to bring all peasants back to the Glass Mountain." 
        
        "No" said an smaller one with a silver chain dress. "This is not a peasant, it is a very small bird. It should be brought to Brdaus."
        
        "No" said the even smaller one with a shiny golden circles on his braid. "This is obviously too small to be of any use. I'm hungry. Let’s eat it."
        
    - else:
        The bigger green dragon said. "All peasants need to be taken back to the Zmaj with seven heads, back to his Dark Keep."
        
        "No", said a smaller dragon, as flames burst from his jaws. "This is not a peasant, it is a very small bird. It should be brought to the three-headed Dragon."
...
==Chapter3Q2C
    ...
    -"Thank you, big human." said the little golden bird in a cage, as {name} opened the little door. "I am an spirit of the mountains, trapped here by these evil creatures. Here, take a feather from my wings. If you ever need of my help, just rub it between your fingers." said the creature and flew away.
...
==Chapter3Q4B
    ...
    And by morning, {Chapter3_badguys} lied down in throng beneath their feet. But yet again { Chapter3_badguys=="dragons": three-headed Dragon was not there. } {Chapter3_badguys=="Hudobni škrats": Brdaus was not there.}
...
{ M22>2:
        ...
        Slashing trough the monster hordes, {pronoun} reached a small clearing by the lake where { Chapter3_badguys=="dragons": Three-headed Dragon} {Chapter3_badguys=="Hudobni škrats": Brdaus} of the {opposer}'s army was. 
-else: 
        And with that {name} held {gender_possesive} stood {gender_possesive} ground, until finally { Chapter3_badguys=="dragons": Three-Headed Dragon} {Chapter3_badguys=="Hudobni škrats": Brdaus}
...
==Chapter3Q5
 ...
 "Roar."  Said the creatures. "So you are the one who keeps me away from the princess. By Gods, I shall { Chapter3_badguys=="dragons": eat you where you stand} {Chapter3_badguys=="Hudobni škrats":crush your bones between my hands, you peasant. I had killed numerous princes before you.}."
    ...
    {M11 < 4: 
        Remembering the words of the old man, {name} sliced all of the <> 
            {Chapter3_badguys=="dragons": heads in a single swing} {Chapter3_badguys=="Hudobni škrats": Brdauses beard with a single swing.}
        ->Chapter3Q5feast
    -else:
        {name} hacked and slashed, but however times {pronoun} might have hit the lieutenant, <>
            {Chapter3_badguys=="dragons": its hide was as tough as leather and heads kept on regrowing} {Chapter3_badguys=="Hudobni škrats": his body took no blows, for his skin was sturdy and iron.}
        ->Chapter3Q5Chase
    }
...
And just as desperation started to set in, the old man, Kosobrin,  whom {name} once feed by the road, huffing and puffing, appeared. 

"Damn. I wanted to tell you, but you ran away too quickly." said Kosobrin. " {Chapter3_badguys=="dragons": You must chop off all heads in a single swing. Otherwise they will keep on regrowing. "} {Chapter3_badguys=="Hudobni škrats": You must cut the beard with a single swing. This is where his power lies."}
...
-
 ...
 ==Chapter4   
 And with the sword, the king gave {name} the best horse in the kingdom, and sent {gender} on {gender_possesive} way to the north in the lands behind the Glass Mountain, where the Vražiji Graben lay, in a land covered by cold and mist and darkness that {opposer} brought.
 ...
 -As {name} was riding down the road, {pronoun} heard a familiar voice.
    ...
    {helper=="fox":
        ...
        It was the little Lisica Zvitorepka, {name} saved from the priests, sitting on a rock, looking at the road. 
        
        "I need of your help."
        
        "I am in great rush now, friend Lisica Zvitorepka. I need to defeat the evil {opposer} before he has taken over all land. Surely, this task is not that difficult?"
    ...
    It was the dwarf Špicparkeljc. He sat on a low branch of an ash tree, swinging 
...
Really. It was there like 50 times?!? What should had it been there to guess right? Fredi Miler? Guess it was just too hard. Oh, now you are messing with me aren’t you? Because I see no other reason for you to do this to me. Ok, now I kill you for good. You are dead.
...
+Please, I promise to take it seriously and not sabotage the research anymore. And try to be serious and all and swear it, so may Fredi take my soul if I don't.

-You mean, Špicparkeljc?

+Yes, Špicob..Škatl..Škpico..Yes that guy
...
*[Next]
    {M13<4 && helper=="fox":
        ...
        "Here" said the {helper}. "Come out, Zlatorog. And meet the hero."
        
        Suddenly a monster, a great goat with golden horns and wings, standing up on its back legs jumped in front of them.
        
        "Stay your sword, { pronoun=="He" && object=="kingdom": prince}{ pronoun=="She" && object=="kingdom": princess} {name}. I mean to help you. I am Zlatorog, a ruler of all lands of the mountains. Once a monarch of this land, now just a castaway."
        
        "What brings you to this barren land?", Zlatorog continued.
    
        "I seek to vanquish the evil {opposer}."
    
        "By Gods, then I might get my mountains back."
    
        "See, I knew I could help". The Lisica Zvitorepka wagged its tail happily.
       ...
       {M13<4: Why, with love and compassion?}
        ...
        Zlatorog bleated with laughter.
    ...
    "Well, you were lucky for paying attention to these things, names of dwarves." {name} turned to see a face in a rock formation behind {gender}. It was a face of Ajdovska deklica, or the heathen maiden, one of the Aidi cursed for prophesying the death of Zlatorog.
    
    "Now my little one, what brings you to this barren land?" continued the maiden.
...
-
    ...
    And  { helper=="fox": Zlatorog}{ helper=="bird": Ajdovska deklica } drank deeply from the bucket.
    ...
    And with a mischievous laugh, { helper=="fox": Zlatorog jumped high in the air}{ helper=="bird": The stones that made the maidens face turned till the face was gone}.
    
    ->Chapter4Q2E

==Chapter4Q2E
+[Next]
-Marching across the ice misty land, {name} reached the great Gate of the {Chapter3_badguys}. It served as the outer ring of the Dark Keep, home of the fierce {opposer}. It was a monumental building, with carvings of the past, by generations and generations of {Chapter3_badguys == "dragons": dragons and wyrms}{Chapter3_badguys == "Hudobni škrats": metal and clay dwarves} had carved. It was an epochal structure significant to the whole monster kind.
   ...
   Now, hero, this is the Great Gate, behind it lies the Dark Keep and inside sits a golden throne and on this throne sits the {opposer}. Now we can try to get inside secretly without the {Chapter3_badguys} seeing us. But it will be perilous.
    ...
    -{pronoun} rubbed it between his fingers, and the little golden bird appeared.
...
{object=="love":
    ...
    "No" thought {name}. "To come so far and to be eaten by this creature. My dear love. What will happen to my dear {gender==true:Katja}{gender==false:Martin}". And with that thought the sword began to radiate and glow.
}
...
{object=="kingdom":
    ...
    {opposer =="Vedomec":
        And with a mighty swing, {name} split the evil sorcerer, out of whom jumped out a wolf. {name} slashed the wolf, out of whom jumped a fox, whom {name} also split. Out of the fox, jumped a rabbit, but {name} quickly caught it and killed it. Out of the rabbit flew a bird, whom {name} quickly shot. Out of the bird then dropped an egg that cracked on the floor, thus destroying evil one's soul. 
        
        With Vedomec dead the hero opened the cells freeing the enslaved people, who thanked {gender} as they walked out.
    -else: 
...
{object=="love":
    ...
    And finally, out of the {opposer=="Vedomec":'s dungeon}{opposer=="Zmaj with seven heads":'s belly}came out {gender==true:Katja}{gender==false:Martin}, who ran in {name}'s arms, finally reunited with their love.
}
+[Next]
->Chapter4Q4
...
{No_of_death==5 && gde_je_bio == "Chapter4": ->kurcspecial} 
...
+Yes, Špin..Špikc..Špar..Yes that guy
